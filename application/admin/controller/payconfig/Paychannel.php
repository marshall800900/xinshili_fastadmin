...
//        'getSearchList'
    ...
    public function _initialize()
    {
        ...
        $this->view->assign("getPayUrlTypeList", $this->model->getGetPayUrlTypeList());
        $this->view->assign("amountTypeList", $this->model->getAmountTypeList());
    ...
    public function index()
    {
        ...
        $list = $this->model
            ...
            ->paginate($limit)
            ->each(function ($value) {
                $value['pay_api_id'] = db()->name('pay_api')
                    ->where('id', $value['pay_api_id'])
                    ->value('api_name');
