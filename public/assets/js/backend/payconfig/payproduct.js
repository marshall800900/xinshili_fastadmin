define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'payconfig/payproduct/index' + location.search,
                    add_url: 'payconfig/payproduct/add',
                    edit_url: 'payconfig/payproduct/edit',
                    del_url: 'payconfig/payproduct/del',
                    multi_url: 'payconfig/payproduct/multi',
                    import_url: 'payconfig/payproduct/import',
                    table: 'pay_product',
                }
            });
